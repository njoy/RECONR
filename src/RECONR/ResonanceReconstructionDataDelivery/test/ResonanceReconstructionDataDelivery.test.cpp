...
std::string MF3(){
 ...
 2.224648+6 3.224648+6          0          0          2          6 125 3  1     
          3          1          6          5                       125 3  1     
 7,000000+0 1.672869+1 2.000000-5 1.182897+1 7.500000+5 3.347392-5 125 3  1     
 ...
 2.224648+6 3.224648+6          0          0          1          6 125 3 16     
          3          1                                             125 3 16     
 7,000000+0 1.672869+1 2.000000-5 1.182897+1 7.500000+5 3.347392-5 125 3 16     
 ...
 2.224648+6 3.224648+6          0          0          2          6 125 3 18     
          3          1          6          2                       125 3 18     
 7,000000+0 1.672869+1 2.000000-5 1.182897+1 7.500000+5 3.347392-5 125 3 18     
...
std::string MEND(){
  return R"(
 0.000000+0 0.000000+0          0          0          0          0  -1 0  0     )";
}
...
ENDFMaterial( std::string ){
  // std::string endf = MF1() + MF3();
  std::string endf = R"(
