    ...
    WHEN( "the cross sections are linearized" ){
      ...
      THEN( "we can check MT=16" ){
        auto lxs16 = lXSs.at( 16 );
				std::vector< double > refE{
					1e-05,       1.25e-05,    1.5e-05,     2e-05,       2e-05,        
					...
					375000,      750000,      750000,      1.9e+07,     1.9e+07,      
					1.95e+07,    1.95e+07,    2e+07 };
				std::vector< double > refB{
					16,          14.5175,     13.4088,        11.829,      11.829,       
					...
					4.81569e-05, 3.34739e-05, 3.34739e-05,    2.75176e-05, 2.75176e-05,  
					2.7313e-05,  2.7313e-05,  2.71079e-05 };
