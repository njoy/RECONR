    ...
    WHEN( "the cross sections are linearized" ){
      ...
      THEN( "we can check MT=18" ){
        ...
        auto reaction = reactions.at( reactionID );
          ...
          150000,  150000,  450000,   600000,    675000,  
          712500,  731250,  740625,   745312,    747656,  
          748828,  749414,  749707,   749854,    749927,  
          749963,  749982,  749991,   749995,    749998,  
          749999,  749999,  750000,   750000,    750000,  
          750000,  750000,  750000,   750000,    750000,  
          750000,  750000,  1.9e+07,  1.95e+07,  2e+07
        };
          ...
          18,      18,           18,           18,          18,           
          18,      18,           18,           18,          18,           
          18,      11.829,       11.829,       11.829,      11.829,       
          11.829,  11.829,       11.829,       11.829,      11.829,       
          11.829,  11.829,       11.829,       11.829,      11.829,       
          11.829,  11.829,       11.829,       11.829,      11.829,       
          11.829,  11.829,       11.829,       11.829,      11.829,       
          11.829,  11.829,       11.829,       11.829,      11.829,       
          11.829,  3.34739e-05,  2.75176e-05,  2.7313e-05,  2.71079e-05
        };
        ...
        details::printV( "MT18 energies", energies | ranges::view::all );
        details::printV( "MT18 barns", barns | ranges::view::all );
