      ...
      THEN( "the productions can be summed up and checked" ){
        ...
        THEN( "MT = 18 can be tested" ){
          ...
          std::vector< double > refP{
            ...
            10.1806,  10.1807,  10.1808,  10.1808,  10.181,   
            10.181,   10.1812,  10.1813,  10.1816,  10.1816,  
            10.1817,  10.182,   10.182,   10.1823,  10.1827,  
            10.183,   10.1831,  10.1833,  10.1833,  10.185,   
            10.185,   10.1863,  10.1925,  10.205,   10.205,   
            10.2163,  10.2467,  10.2875,  10.3467,  10.3633,  
            10.38,    10.3967,  10.4133,  10.43,    10.4467,  
            10.6533,  10.8133,  10.8133,  10.83,    10.83,    
            10.8467,  10.8467,  11.18
        };
